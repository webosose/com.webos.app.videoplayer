...
describe('Picker Specs', () => {
	...
	test.skip('should have a default \'value\' of 0', () => {
		const picker = mount(
	...
	test.skip('should not run the onChange handler when disabled', () => {
		const handleChange = jest.fn();
		const picker = mount(
	...
	test.skip('should increment by \'step\' value', () => {
		const handleChange = jest.fn();
		const picker = mount(
	...
	test.skip('should decrement by \'step\' value', () => {
		const handleChange = jest.fn();
		const picker = mount(
	...
	test.skip('should increment by \'step\' value and wrap successfully', () => {
		const handleChange = jest.fn();
		const picker = mount(
	...
	test.skip('should decrement by \'step\' value and wrap successfully', () => {
		const handleChange = jest.fn();
		const picker = mount(
		...
		() => {
			const picker = mount(
				<Picker index={0} max={1} min={-1} joined orientation="horizontal">
					<PickerItem>test.skip one picker</PickerItem>
				</Picker>
			);
