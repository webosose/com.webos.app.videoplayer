...
import Transition from './PopupBase/Transition';
 ...
 *
 * @class PopupBase
 * @memberof goldstone/Popup
 * @ui
 * @public
 */

const PopupBase = function ({children, noAnimation, onHide, onShow, open, position, spotlightId, spotlightRestrict, ...rest}) {
	const direction = transitionDirection[position];
	const appendedClassName = classNames(componentCss.popup, 'neutral', 'highContrast', componentCss[position]);
	const transitionContainerClassName = classNames(componentCss.popupTransitionContainer, componentCss[position]);
	return (
		<TransitionContainer
		...
		>
			...
			>
				<div className={componentCss.body}>
					{children}
				</div>
			</div>
		</TransitionContainer>
...
PopupBase.propTypes = {
	...
	/**
				 ...
				 *
				 * Note: The ready-to-use [Popup]{@link goldstone/Popup.Popup} component only supports
 ...
 *
 * @class Popup
 * @memberof golddstone/Popup
 * @extends goldstone/Popup.PopupBase
 * @ui
 * @public
 */
...
class Popup extends React.Component {
	...
	static propTypes = /** @lends goldstone/Popup.Popup.prototype */ {
		/**
		 ...
		 * [noAnimation]{@link goldstone/Popup.PopupBase#noAnimation} is `true`.
		 *
		 * @type {Function}
		 * @public
		 */
